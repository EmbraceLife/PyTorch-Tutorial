...
def train(args):
	...
	if train_again:
		rnn = torch.load("/Users/Natsume/Downloads/temp_folders/402_train_rnn/net.pkl")
		optimizer = torch.optim.Adam(rnn.parameters(), lr=0.01)
		loss_func = nn.CrossEntropyLoss()
		steps, losses_train, losses_val, accuracies = torch.load("/Users/Natsume/Downloads/temp_folders/402_train_rnn/log.pkl")
	...
	for epoch_idx in range(args.num_epochs):
		...
		for batch_idx, (batch_img, batch_lab) in enumerate(train_loader):
			...
			if batch_idx % 10 == 0:
				...
				# apply test|validation set to rnn model
	...
	if plot_loss:
		plt.plot(steps, losses_train, c='blue')
		plt.plot(steps, losses_val, c='red')
		plt.show()
